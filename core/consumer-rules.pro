...
-keep class com.example.core.data.source.remote.response.** { *; }
 ...
 # Keep all fields with the @SerializedName annotation
-keepclassmembers class com.example.core.data.source.remote.response.** {
     @com.google.gson.annotations.SerializedName <fields>;
}

 # Keep all methods with the @SerializedName annotation
-keepclassmembers class com.example.core.data.source.remote.response.** {
     @com.google.gson.annotations.SerializedName <methods>;
}

 # Keep the no-args constructor of your data classes
-keepclassmembers class com.example.core.data.source.remote.response.** {
     <init>();
}
